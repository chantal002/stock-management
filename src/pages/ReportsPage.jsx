...
const sections = [
  { key: "products", label: "Available Stock", cols: ["Code", "Name", "Qty", "Price"], keys: ["product_code", "product_name", "quantity_in_stock", "unit_price"] },
  { key: "stockIn", label: "Stock In", cols: ["Date", "Qty", "Product", "Warehouse"], keys: ["transaction_date", "quantity_moved", "product_code", "warehouse_code"] },
  { key: "stockOut", label: "Stock Out", cols: ["Date", "Qty", "Product", "Warehouse"], keys: ["transaction_date", "quantity_moved", "product_code", "warehouse_code"] },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted text-sm">Daily, weekly, and monthly stock and transaction reports</p>
      </div>
