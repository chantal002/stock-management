...
const links = [{"to":"/","label":"Products"},{"to":"/warehouses","label":"Warehouse"},{"to":"/transactions","label":"Transactions"},{"to":"/reports","label":"Reports"}];
    ...
    <div className="min-h-screen bg-surface text-ink md:grid md:grid-cols-[260px_1fr]">
      <aside className="bg-sidebar text-sidebar-text md:min-h-screen border-b-4 border-accent md:border-b-0 md:border-r-4">
        <div className="px-5 py-6 border-b border-white/10">
          <p className="text-xs uppercase tracking-widest text-accent">Stock Management System</p>
          <h1 className="text-xl font-bold mt-1">SMS</h1>
        </div>
